      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        ...
        >
          <div className="lg:hidden text-center mb-10">
            <h1 className="text-4xl font-black tracking-tighter text-white drop-shadow-[0_0_10px_rgba(0,242,255,0.5)]">
              FORESIGHT
            </h1>
          </div>
          ...
          <div className="flex p-1 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl mb-8 relative">
            ...
            <button
              ...
              className={`flex-1 py-3 text-[10px] font-black uppercase tracking-widest z-10 transition-colors duration-300 ${activeTab === "login" ? "text-white" : "text-slate-500 hover:text-slate-300"}`}
            >
              Iniciar Sesión
            </button>
            <button
              onClick={() => setActiveTab("register")}
              className={`flex-1 py-3 text-[10px] font-black uppercase tracking-widest z-10 transition-colors duration-300 ${activeTab === "register" ? "text-white" : "text-slate-500 hover:text-slate-300"}`}
            >
              Registrarse
            </button>
          </div>
              ...
              {activeTab === "login" ? (
                ...
                >
                  ...
                  {(generalError || successMessage) && (
                    <div
                      className={`mb-6 p-4 border rounded-xl text-sm text-center ${generalError ? "bg-red-500/10 border-red-500/20 text-red-400" : "bg-green-500/10 border-green-500/20 text-green-400"}`}
                    >
                      {generalError || successMessage}
                    </div>
                  )}
                  ...
                  >
                    <div className="group/input">
                      <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 ml-1 mb-2 block group-focus-within/input:text-[#00f2ff]">
                        Email-Correo
                      </label>
                      <input
                        {...registerLogin("email")}
                    ...
                    <div className="group/input">
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder="••••••••"
                          className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-white placeholder:text-slate-600 outline-none focus:border-[#00f2ff] transition-all duration-500"
                        />
                        <button
                          type="button"
                    ...
                    <motion.button
                      ...
                      className="w-full bg-white text-black font-black py-4 rounded-xl flex items-center justify-center gap-2 mt-6 relative overflow-hidden"
                    >
                      <motion.div
                ...
                >
                  <div className="mb-6 text-center lg:text-left">
                    ...
                    <p className="text-slate-400 text-sm">
                      Crea una nueva identidad en Foresight.
                    </p>
                  </div>
                  ...
                  >
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className={`py-4 rounded-xl border transition-all duration-500 flex flex-col items-center gap-1 ${selectedRole === "EMPRESA" ? "bg-[#0070f3]/20 border-[#0070f3] text-white" : "bg-white/5 border-white/10 text-slate-500"}`}
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          setValueRegister("role", "EMPLEADO");
                          setValueRegister("companyName", "");
                        }}
                        className={`py-4 rounded-xl border transition-all duration-500 flex flex-col items-center gap-1 ${selectedRole === "EMPLEADO" ? "bg-[#0070f3]/20 border-[#0070f3] text-white" : "bg-white/5 border-white/10 text-slate-500"}`}
                      >
                    ...
                    {selectedRole === "EMPRESA" && (
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-[#00f2ff]"
                      />
                    )}
                    ...
                    <motion.button
                      ...
                      className="w-full bg-[#0070f3] text-white font-black py-4 rounded-xl mt-4"
                    >
